...
def get_lms_app_name():
	name = os.environ.get("LMS_APP_NAME") or "Pa's Academy"
	if frappe.conf and frappe.conf.get("lms_app_name"):
		name = frappe.conf.get("lms_app_name")
	return name
...
app_title = get_lms_app_name()
app_icon_title = get_lms_app_name()
...
after_migrate = [
	...
	"lms.install.sync_app_name_from_config",
]
...
permission_query_conditions = {
	...
	"LMS Course": "lms.lms.permissions.course_query_conditions",
	"LMS Enrollment": "lms.lms.permissions.enrollment_query_conditions",
	"Course Lesson": "lms.lms.permissions.course_lesson_query_conditions",
	"Course Chapter": "lms.lms.permissions.course_chapter_query_conditions",
	"LMS Quiz": "lms.lms.permissions.quiz_query_conditions",
	"LMS Assignment": "lms.lms.permissions.assignment_query_conditions",
	"LMS Course Review": "lms.lms.permissions.course_review_query_conditions",
	"LMS Course Progress": "lms.lms.permissions.course_progress_query_conditions",
	...
	"LMS Certificate Request": "lms.lms.permissions.certificate_request_query_conditions",
	"LMS Certificate Evaluation": "lms.lms.permissions.certificate_evaluation_query_conditions",
}

has_permission = {
	"LMS Course": "lms.lms.permissions.course_has_permission",
	...
	"LMS Quiz": "lms.lms.permissions.related_course_has_permission",
	"LMS Assignment": "lms.lms.permissions.related_course_has_permission",
	"LMS Course Review": "lms.lms.permissions.related_course_has_permission",
	"LMS Course Progress": "lms.lms.permissions.related_course_has_permission",
	"LMS Quiz Submission": "lms.lms.permissions.related_course_has_permission",
	"LMS Assignment Submission": "lms.lms.permissions.related_course_has_permission",
	"LMS Certificate Request": "lms.lms.permissions.related_course_has_permission",
	"LMS Certificate Evaluation": "lms.lms.permissions.related_course_has_permission",
...
scheduler_events = {
	...
	"daily": [
		...
		"lms.lms.api.expire_pending_invites",
